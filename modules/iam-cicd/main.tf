...
resource "aws_iam_policy" "cicd" {
  ...
  description = "CI/CD policy for ${var.project} ${var.env}"
...
resource "aws_iam_policy" "tf_state" {
  name        = "${var.project}-${var.env}-terraform-state-policy"
  description = "Allow GitHub Actions to access Terraform state bucket and lock table"
