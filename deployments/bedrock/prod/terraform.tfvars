...
# Knowledge Base
kb_name        = "main"
kb_description = "VocaNote prod knowledge base — voice notes and medical terminology"
...
# S3 Vectors — auto-named: vocuone-prod-s3-vector-store / vocuone-prod-kb-index
