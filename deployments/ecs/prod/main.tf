...
locals {
  ...
  # GenAI Observability NOT activated on prod yet — pending verification on stage.
  # To activate, restore the concat() below:
...
module "api_gateway" {
  ...
  # Timeout — REST API supports up to 60s with Service Quotas increase (approved)
